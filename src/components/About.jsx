...
const About = () => {
  return (
    <div className="flex justify-center items-center">
      <Element name="about">
        <div className="">
          <section className="h-auto w-full  flex flex-col  justify-center  gap-5 pt-40">
            <motion.div
            ...
            >
              Hi, I'm Hassan, a front-end web developer. I have a strong
              knowledge of HTML, CSS, JavaScript, and framework and libraries
              such as React js, Chakra UI and Bootstrap. I also have experience
              in working with APIs, databases, and web design tools such as
              Photoshop and Figma. I enjoy solving problems, learning new
              technologies, and collaborating with other developers and
              designers. I'm always looking for new challenges and opportunities
              to improve my skills and deliver high-quality products to my
              clients. In my spare time, I like to playing to physical
              activities. Thank you for reading my note. I hope to hear from you
              soon.
            </motion.p>
            <motion.div
              variants={SlideRight(0.6)}
            ...
            <section>
              ...
              >
                ...
                <div>
                  <img
                    className="shadow-lg shadow-sky-400 hover:shadow-xl hover:shadow-sky-500 border-2 border-sky-500 rounded-2xl h-23 w-24 px- py-2 transition-all duration-500 hover:-translate-y-4"
                    src="css2.jpeg"
                    alt=""
                  />
                </div>
